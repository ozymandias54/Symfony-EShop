 ...
 */
final class Version20221224111522 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customers (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, address VARCHAR(65) NOT NULL, zipcode VARCHAR(55) NOT NULL, city VARCHAR(65) NOT NULL, UNIQUE INDEX UNIQ_62534E219D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
